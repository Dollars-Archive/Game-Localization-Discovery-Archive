...
| [Fantastic Fortune 2 (판타스틱 포츈2)](games/fantastic-fortune-2.md) | 2003 | 판타지·육성·여성향 연애 시뮬레이션/ADV | ⭐⭐⭐½☆ | C | Gavas 4.5/5 (8건) / Joko 3.72/5 (리뷰 10건 이상) / GameFAQs Good (15표) | 공개적으로 확인되지 않음 | PS2 원판 → PS2 `Triple Star` 시스템·UI·외전 강화 → Windows 이식 | 🟢 후보 |
